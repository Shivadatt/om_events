...
# Service Account creds — needed for Admin SDK (Firestore server writes)
...
LOGGING = {
    ...
    "handlers": {
        ...
        "file": {"class": "logging.handlers.RotatingFileHandler", "filename": BASE_DIR / "logs" / "application.log",
                 "maxBytes": 2_000_000, "backupCount": 5, "formatter": "standard"},
    },
